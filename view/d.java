...
public class d {
    ...
    public static boolean e(@NonNull a aVar, View view, Window.Callback callback, @NonNull KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? aVar.superDispatchKeyEvent(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && g.j(view, keyEvent)) || aVar.superDispatchKeyEvent(keyEvent);
    }
